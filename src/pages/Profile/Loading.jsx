...
const ProfileLoading = () => {
  ...
  return (
    ...
    <aside className=" animate-pulse lg:grid lg:grid-cols-[repeat(2,minmax(280px,320px))] lg:place-content-center lg:grid-rows-[110px_50px] lg:gap-x-10 lg:gap-y-4 xl:flex m-auto lg:m-0 h-full min-w-280 w-full sm:max-w-full md:max-w-[300px] lg:max-w-full xl:max-w-[380px] bg-liwr-400 dark:bg-perl-500/50 rounded-lg px-8 py-8 flex flex-col">
      ...
      <div className="w-1/3 h-6 bg-liwr-900/40 dark:bg-perl-200/50 rounded-xl m-auto">
